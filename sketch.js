...
function setup() {
	...
	side=createSprite(340,620,20,80);
	side.shapeColor="red";

	side2=createSprite(440,620,20,80);
	side2.shapeColor="red";

	bottom=createSprite(390,650,100,20);
...
function draw() {
  ...
  drawSprites();
  if(isTouching(packageSprite,bottom)){
	isStatic:true;
	restitution:0
  }
}
